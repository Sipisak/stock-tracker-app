        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="alert-dialog">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 pt-4">
                    ...
                    <InputField name="threshold" label="Threshold" placeholder="e.g., 150.50" type="number" step="any"  register={register} error={errors.threshold} validation={{ required: 'Threshold is required', valueAsNumber: true }} />
